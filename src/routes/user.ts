...
router.get("/:id", checkSchema(GET_USER_SCHEMA), validateAllParams, controller.getUser.bind(controller));
router.post("/", checkSchema(CREATE_USER_SCHEMA), validateAllParams, controller.createUser.bind(controller));
router.put("/:id", checkSchema(UPDATE_USER_SCHEMA), validateAllParams, controller.updateUser.bind(controller));
router.put(
  "/state/:id",
